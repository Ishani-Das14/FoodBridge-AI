...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-700 relative overflow-hidden">
        ...
        <div className="relative space-y-4">
          <h1 className="text-4xl font-bold text-white leading-tight">
            Nourishing communities,<br />together.
          </h1>
          <p className="text-emerald-100 text-lg leading-relaxed max-w-sm">
            Access surplus food from local restaurants and deliver it directly to those in need.
          </p>
        </div>
        <div className="relative flex items-center gap-6">
          {[
            { value: '24/7', label: 'Live Donations' },
            { value: '150+', label: 'Active Volunteers' },
            { value: '2.5M', label: 'Meals Delivered' },
          ].map(({ value, label }) => (
            <div key={label}>
      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-white">
        <div className="w-full max-w-md space-y-8">
          <div>
            <h2 className="text-3xl font-bold text-slate-900">NGO Sign in</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input id="email" type="email" name="email" required value={form.email} onChange={handleChange} placeholder="ngo@example.com" className="input pl-10" />
              </div>
            </div>
            <div>
